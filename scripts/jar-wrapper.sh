...
jdk_path=$(dirname "${prog}")

# b/452243072: Pin the dokka runs to JDK 21 until we update the JavaVersion
# check to allow 25.
jdk_path="${jdk_path}/../../../../prebuilts/jdk/jdk21"

if [ -d "${jdk_path}" ]
then
  java="${jdk_path}/linux-x86/bin/java"
fi
